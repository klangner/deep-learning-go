...
from gomoku.ruleset import GameState, Player, Point
from gomoku.utils import print_board
from gomoku.rl import experience
...
def main():
    ...
    parser.add_argument('--work-dir', '-d', 'model')
    parser.add_argument('--num-workers', '-w', type=int, default=5)
